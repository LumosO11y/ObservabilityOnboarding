...
14. When should the collector be stateful? What state will it keep? Why won't we keep stateful collectors most of the time? What are the pros and cons between the two? Explain in detail.
